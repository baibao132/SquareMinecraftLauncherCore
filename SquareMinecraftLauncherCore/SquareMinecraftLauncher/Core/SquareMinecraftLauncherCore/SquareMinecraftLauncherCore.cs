namespace SquareMinecraftLauncher.Core
{
    ...
    internal sealed class SquareMinecraftLauncherCore
    {
        ...
        internal async void opKeep(string version, string patch, string java)
        {
            await new Tools().OptifineInstall(version, patch, java);
        }
